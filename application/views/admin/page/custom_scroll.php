                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <div class="row">
                                <div class="col-sm-3"><img src="<?php echo base_url(); ?>optimum/plugins/images/big/img1.jpg" class="img-fluid  " /></div>
                                <div class="col-sm-9">
                                    <div id="slimtest1">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <div id="slimtest2">
                                <div class="row">
                                    <div class="col-sm-3"><img src="<?php echo base_url(); ?>optimum/plugins/images/big/img2.jpg" class="img-responsive" /></div>
                                    <div class="col-sm-9">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam rhoncus, felis interdum condimentum consectetur, nisl libero elementum eros, vehicula congue lacus eros non diam. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
                                        <p>Vivamus mauris lorem, lacinia id tempus non, imperdiet et leo. Cras sit amet erat sit amet lacus egestas placerat. </p>
                                        <p>Aenean ultricies ultrices mauris ac congue. In vel tortor vel velit tristique tempus ac id nisi. Proin quis lorem velit. Nunc dui dui, blandit a ullamcorper vitae, congue fringilla lectus. Aliquam ultricies malesuada feugiat. Vestibulum placerat turpis et eros lobortis vel semper sapien pulvinar.</p>
                        ...
                        <div class="white-box">
                            ...
                            <div id="slimtest3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-3"><img src="<?php echo base_url(); ?>optimum/plugins/images/big/img3.jpg" class="img-responsive" /></div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <div id="slimtest4">
                                <div class="row">
                                    <div class="col-sm-3"><img src="<?php echo base_url(); ?>optimum/plugins/images/big/img4.jpg" class="img-responsive" /></div>
                                    <div class="col-sm-9">
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam rhoncus, felis interdum condimentum consectetur, nisl libero elementum eros, vehicula congue lacus eros non diam. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
                                        <p>Vivamus mauris lorem, lacinia id tempus non, imperdiet et leo. Cras sit amet erat sit amet lacus egestas placerat. </p>
                                        <p>Aenean ultricies ultrices mauris ac congue. In vel tortor vel velit tristique tempus ac id nisi. Proin quis lorem velit. Nunc dui dui, blandit a ullamcorper vitae, congue fringilla lectus. Aliquam ultricies malesuada feugiat. Vestibulum placerat turpis et eros lobortis vel semper sapien pulvinar.</p>
