<!--.row-->
 ...
 <h3 class="box-title">Simple Cards</h3>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="card">
                                        <img class="card-img-top image-responsive" src="<?php echo base_url(); ?>optimum/plugins/images/cards/1.jpg" alt="Card image cap">
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <img class="card-img-top image-responsive" src="<?php echo base_url(); ?>optimum/plugins/images/cards/2.jpg" alt="Card image cap">
                                        <div class="card-block">
                                            <h4 class="card-title">Card title</h4>
                                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                            <a href="#" class="btn btn-primary">Go somewhere</a>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <img class="card-img-top image-responsive" src="<?php echo base_url(); ?>optimum/plugins/images/cards/3.jpg" alt="Card image cap">
                                        <div class="card-block">
                                            <h4 class="card-title">Card title</h4>
                                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                            <a href="#" class="btn btn-primary">Go somewhere</a>
                    ...
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="card">
                                        <img class="card-img-top" src="<?php echo base_url(); ?>optimum/plugins/images/cards/5.jpg" alt="Card image cap">
                                        <div class="card-block">
                                            <h4 class="card-title">Card title</h4>
                                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <img class="card-img-top" src="<?php echo base_url(); ?>optimum/plugins/images/cards/3.jpg" alt="Card image cap">
                                        <div class="card-block">
                                            <h4 class="card-title">Card title</h4>
                                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card">
                                        <img class="card-img-top" src="<?php echo base_url(); ?>optimum/plugins/images/cards/4.jpg" alt="Card image cap">
                                        <div class="card-block">
                                            <h4 class="card-title">Card title</h4>
                                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="white-box">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card">
                                        <img class="card-img-top" src="<?php echo base_url(); ?>optimum/plugins/images/cards/6.jpg" alt="Card image cap">
                                        <div class="card-block">
                                            <h4 class="card-title">Card title</h4>
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        ...
                                        <img class="card-img-bottom" src="<?php echo base_url(); ?>optimum/plugins/images/cards/6.jpg" alt="Card image cap">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="card card-inverse">
                                        <img class="card-img" src="<?php echo base_url(); ?>optimum/plugins/images/cards/7.jpg" alt="Card image">
