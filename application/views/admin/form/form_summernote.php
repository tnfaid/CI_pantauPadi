 <!-- .row -->
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Air mode Inline editior</h3>
                            <small>Select some text to edit via summernote</small>
                            <hr>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">Click to edit</h3>
                            ...
                            <a id="edit" class="btn btn-info btn-rounded" onClick="edit()" type="button">Edit</a>
                            <a id="save" class="btn btn-success btn-rounded" onClick="save()" type="button">Save</a>
                        </div>
                    </div>
                </div>
                <!-- /.row -->