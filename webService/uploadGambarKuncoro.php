<?php
	...
	if (empty($nama_penyakit)) { 
		...
		$query = mysqli_query($con, "INSERT INTO daun (gambar,nama_penyakit, user_id, kondisi, solusi, penulis, usia, value_warna, tanggal_upload) VALUES ('$path','$nama_penyakit','$user_id', '$kondisi', '$solusi', '$penulis', '$usia', '$value_warna', '$tanggal_upload')");
